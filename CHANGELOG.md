...
### Fixed
- Corrected BFS→DFS documentation references in README, MCP tool docstring, CLI help text, and module docstring to match the actual `DFSDeepCrawlStrategy` implementation (closes #18).
